...
class AlienInvasion():
    ...
    def run_game(self):
        ...
        while True:
            ...
            self._check_events()
            # Вызываем метод update при каждом проходе цикла.
            self.ship.update()
            # Обновление снарядов на экране
            self._update_bullets()
            # Обновление пришельцев на экране
            self._update_aliens()
    ...
    def _update_bullets(self):
        ...
        # Обновление позиций снарядов и удаление старых пуль.
        self.bullets.update()
